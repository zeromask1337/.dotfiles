...
export PATH="$PATH:/opt/local/bin/openfortivpn"
export PATH=$HOME/.deno/bin:/usr/bin:/bin:/usr/sbin:/sbin:$HOME/.volta/bin:/opt/local/bin/openfortivpn:/opt/local/bin
